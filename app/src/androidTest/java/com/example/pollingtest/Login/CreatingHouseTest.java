...
public class CreatingHouseTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void creatingHouseTest() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.register_email),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("mark@test.test.com"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.createHouse), withText("Create House Group"),
                        childAtPosition(
                                childAtPosition(
